...
class CertificateGen(object):
    ...
    def __init__(self, course_id, template_pdf=None, aws_id=None, aws_key=None,
        ...
        try:
            ...
            self.teacher_separate_line = teacher_separate_line or cert_data.get('TEACHER_SEPARATE_LINE', '')
#            log.critical("long_course after: {0}".format(self.long_course.decode('utf-8')))
    ...
    def create_and_upload(
        ...
        log.info("Grade is {}".format(grade))
    ...
    def _generate_certificate(
        ...
        versionmap = {
            ...
            'Prometheus': self._generate_prometheus_certificate
        }
    ...
    def _generate_prometheus_certificate(
        self,
        student_name,
        download_dir,
        verify_dir,
...
#            styleOpenSans.leading = 21
        ...
        elif 'PP101' in self.course or 'PP102' in self.course or 'PP202' in self.course:
            styleOpenSansLight.fontSize = 12
            paragraph_string = "наданий платформою масових відкритих онлайн-курсів <b>Prometheus</b>."
            paragraph = Paragraph(paragraph_string, styleOpenSansLight)
            paragraph.wrapOn(c, WIDTH * mm, HEIGHT * mm)
